...
1. Clone the repository and start the demo:
    ```
    https://github.com/Mihir-Khare429/Spark-Kafka-Cassandra-Streaming-Pipeline.git
    ```
...
- link:
  ```
  https://github.com/Mihir-Khare429/Airflow-spark-Postgres-integration.git
  ```
- Build command
  ```
...
## Maintainer
This project is maintained by Mihir Khare, a Software Engineer with over 3 years of experience in building scalable software and data infrastructure. His expertise includes Python, Java, SQL, and distributed systems.

- GitHub: https://github.com/Mihir-Khare429
- LinkedIn: http://linkedin.com/in/mihir-khare
